...
<div class="phone">
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:14px">Artists</div>
        <div class="list-item"><div class="avatar-sq" style="width:40px;height:40px;background:#3b82f620;font-size:18px">🎤</div><div style="flex:1"><div style="font-size:13px;font-weight:600;color:#111">Disclosure</div><div style="font-size:11px;color:#9ca3af">UK House</div></div><span class="badge badge-green">Published</span></div><div class="list-item"><div class="avatar-sq" style="width:40px;height:40px;background:#3b82f620;font-size:18px">🎤</div><div style="flex:1"><div style="font-size:13px;font-weight:600;color:#111">Mall Grab</div><div style="font-size:11px;color:#9ca3af">House</div></div><span class="badge badge-green">Published</span></div><div class="list-item"><div class="avatar-sq" style="width:40px;height:40px;background:#3b82f620;font-size:18px">🎤</div><div style="flex:1"><div style="font-size:13px;font-weight:600;color:#111">Peggy Gou</div><div style="font-size:11px;color:#9ca3af">House / DJ</div></div><span class="badge badge-gray">Draft</span></div>
        <button class="btn-primary" style="margin-top:8px;font-size:13px">+ Add Artist</button>
      </div>
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:14px">New Artist</div>
        <div class="field-group"><div class="field-label">Stage Name</div><div class="field-input focused">Peggy Gou</div></div>
        <div class="field-group"><div class="field-label">Genre</div><div class="field-input">House / DJ</div></div>
        <div class="field-group"><div class="field-label">Instagram</div><div class="field-input">@peggygou</div></div>
        <div class="field-group"><div class="field-label">Spotify URL</div><div class="field-input" style="color:#9ca3af">https://open.spotify.com/…</div></div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 2: Internal notes section -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:14px;font-weight:700;color:#111;margin-bottom:14px">Peggy Gou · Internal</div>
        <div class="field-group"><div class="field-label">Booking Agent</div><div class="field-input">Agency Name / Email</div></div>
        <div class="field-group"><div class="field-label">Booking Fee</div><div class="field-input">$0</div></div>
        <div class="field-group"><div class="field-label">Internal Notes</div>
          <div style="background:#fff;border:1px solid #e8e5f0;border-radius:10px;padding:10px 12px;font-size:13px;color:#9ca3af;min-height:72px">Rider requirements, notes…</div>
        </div>
        <div style="background:#fef9c3;border-radius:10px;padding:10px 12px;font-size:11px;color:#ca8a04;margin-top:4px">🔒 These fields are hidden in Confidential Mode</div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 3: Saved artist with publish option -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        <div class="card-row" style="margin-bottom:14px">
          <div style="width:48px;height:48px;border-radius:14px;background:#3b82f620;display:flex;align-items:center;justify-content:center;font-size:22px">🎤</div>
          <div>
            <div style="font-size:15px;font-weight:700;color:#111">Peggy Gou</div>
            <div class="badge badge-amber" style="margin-top:2px">Draft</div>
          </div>
        </div>
        <div class="field-group"><div class="field-label">Genre</div><div class="field-val">House / DJ</div></div>
        <div class="field-group"><div class="field-label">Instagram</div><div class="field-val">@peggygou</div></div>
        <button class="btn-primary" style="margin-top:10px">Publish Artist</button>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">Artist List</div>
  <div class="step-body">The <strong>Artists</strong> module shows all artists for your active event. Published artists are live on your site; Draft ones are hidden.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Adding an Artist</div>
  <div class="step-body">Tap <strong>+ Add Artist</strong> and fill in the public fields: stage name, genre, social links. Save as Draft first to review before publishing.</div>
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Internal Fields</div>
  <div class="step-body">Scroll down to see internal-only fields like booking agent, fee, and notes. These are hidden in Confidential Mode and never exposed via the public WP REST API.</div>
  <div class="step-tip">Field visibility is controlled by which ACF field group the field belongs to — no code changes needed.</div>
  <div class="step-nav">
    <button class="btn-prev" id="btn-prev" style="visibility:visible">← Back</button>
    <button class="btn-next" id="btn-next">Next →</button>
  </div>
...
<div class="step-panel" id="panel-3" style="display:none">
  ...
  <div class="step-title">Publishing the Artist</div>
  <div class="step-body">Once you're happy with the data, tap <strong>Publish Artist</strong>. The artist becomes live on your WordPress site immediately.</div>
