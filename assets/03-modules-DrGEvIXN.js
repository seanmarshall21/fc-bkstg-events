...
<title>Tutorial: Home Screen & Modules — VC Event Manager</title>
<style>
...
<body>
<h1 class="page-head">Tutorial · Home Screen & Modules</h1>
<div class="phone">
  <div class="notch"><div class="notch-pill"></div></div>
  <div class="screen">

    <!-- Slide 0: Home dashboard -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:13px;font-weight:700;color:#111;margin-bottom:4px">CRSSD 2026</div>
        <div class="badge badge-purple" style="margin-bottom:14px">onsale</div>
    ...
    <!-- Slide 1: Settings module toggles -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:14px">Settings</div>
        <div style="font-size:13px;font-weight:600;color:#374151;margin-bottom:10px">Visible Sections</div>
        <div class="toggle-row"><span style="font-size:13px;color:#374151">Artists</span><div class="toggle on"></div></div><div class="toggle-row"><span style="font-size:13px;color:#374151">Lineup</span><div class="toggle on"></div></div><div class="toggle-row"><span style="font-size:13px;color:#374151">Sponsors</span><div class="toggle off"></div></div><div class="toggle-row"><span style="font-size:13px;color:#374151">Events</span><div class="toggle on"></div></div><div class="toggle-row"><span style="font-size:13px;color:#374151">Styles</span><div class="toggle off"></div></div><div class="toggle-row"><span style="font-size:13px;color:#374151">Genres</span><div class="toggle on"></div></div>
      </div>
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        ...
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px;padding:8px 0">
          <div style="display:flex;flex-direction:column;align-items:center;gap:5px"><div style="width:52px;height:52px;border-radius:16px;background:#3b82f620;display:flex;align-items:center;justify-content:center;font-size:22px">🎤</div><span style="font-size:10px;color:#374151;font-weight:500">Artists</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:5px"><div style="width:52px;height:52px;border-radius:16px;background:#a855f720;display:flex;align-items:center;justify-content:center;font-size:22px">🎧</div><span style="font-size:10px;color:#374151;font-weight:500">Lineup</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:5px"><div style="width:52px;height:52px;border-radius:16px;background:#f9731620;display:flex;align-items:center;justify-content:center;font-size:22px">📅</div><span style="font-size:10px;color:#374151;font-weight:500">Events</span></div><div style="display:flex;flex-direction:column;align-items:center;gap:5px"><div style="width:52px;height:52px;border-radius:16px;background:#06b6d420;display:flex;align-items:center;justify-content:center;font-size:22px">🏷</div><span style="font-size:10px;color:#374151;font-weight:500">Genres</span></div>
        </div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">Home Screen & Modules</div>
  <div class="step-body">The home screen shows all <strong>active modules</strong> for your current site as icon tiles. Tap any tile to open that section.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Toggle Modules On/Off</div>
  <div class="step-body">Go to <strong>Settings → Visible Sections</strong> and tap any module to show or hide it from the home screen.</div>
  <div class="step-tip">Hide modules you don't use to keep the home screen clean. You can always re-enable them later.</div>
  <div class="step-nav">
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Reorder Modules</div>
  <div class="step-body">In Settings, <strong>long-press a module row</strong> and drag it to a new position. The home screen tile grid updates to match.</div>
