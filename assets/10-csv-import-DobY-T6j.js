...
<div class="phone">
  ...
  <div class="screen">
    ...
    <!-- Slide 0: Artists module with Import option -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px">
          <div style="font-size:16px;font-weight:700;color:#111">Artists</div>
          <button style="background:#f3f1f8;border:none;border-radius:10px;padding:7px 12px;font-size:12px;font-weight:600;color:#7c2dff">Import CSV</button>
        </div>
        <div style="text-align:center;padding:28px 16px;color:#9ca3af">
          <div style="font-size:36px;margin-bottom:8px">🎤</div>
          <div style="font-size:13px">No artists yet</div>
        </div>
      </div>
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:4px">Import Artists</div>
        <div style="font-size:12px;color:#9ca3af;margin-bottom:14px">CSV file · one artist per row</div>
        <div class="upload-zone">
          <div style="font-size:28px">📥</div>
          <div style="font-size:12px;font-weight:600;color:#7c2dff">Select CSV File</div>
          <div style="font-size:11px;color:#9ca3af">Required columns: name, genre</div>
        </div>
        <div style="background:#f9f8fc;border:1px solid #e8e5f0;border-radius:10px;padding:10px 12px;font-size:11px;color:#6b7280;line-height:1.5">
          <strong>Required columns:</strong> name<br>
          <strong>Optional:</strong> genre, instagram, spotify_url, status
        </div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 2: Preview table -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="font-size:14px;font-weight:700;color:#111;margin-bottom:10px">Preview — 4 artists</div>
        <div style="border:1px solid #e8e5f0;border-radius:12px;overflow:hidden;font-size:11px;margin-bottom:12px">
          <div style="display:grid;grid-template-columns:1fr 1fr 80px;background:#f3f1f8;padding:8px 10px;font-weight:700;color:#374151">
            <span>Name</span><span>Genre</span><span>Status</span>
          </div>
          <div style="display:grid;grid-template-columns:1fr 1fr 80px;padding:7px 10px;border-top:1px solid #f3f4f6;color:#374151"><span>Disclosure</span><span>UK House</span><span class="badge badge-gray" style="font-size:9px">Draft</span></div><div style="display:grid;grid-template-columns:1fr 1fr 80px;padding:7px 10px;border-top:1px solid #f3f4f6;color:#374151"><span>Mall Grab</span><span>House</span><span class="badge badge-gray" style="font-size:9px">Draft</span></div><div style="display:grid;grid-template-columns:1fr 1fr 80px;padding:7px 10px;border-top:1px solid #f3f4f6;color:#374151"><span>Peggy Gou</span><span>House</span><span class="badge badge-gray" style="font-size:9px">Draft</span></div><div style="display:grid;grid-template-columns:1fr 1fr 80px;padding:7px 10px;border-top:1px solid #f3f4f6;color:#374151"><span>Yaeji</span><span>Electronic</span><span class="badge badge-gray" style="font-size:9px">Draft</span></div>
        </div>
        <button class="btn-primary" style="font-size:13px">Import All as Draft</button>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 3: Import complete -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        <div style="text-align:center;padding:24px 16px">
          ...
          <div style="font-size:16px;font-weight:700;color:#111;margin-bottom:4px">Import Complete</div>
          <div style="font-size:13px;color:#6b7280">4 artists created as Draft</div>
        </div>
        <div class="list-item"><div class="avatar-sq" style="width:36px;height:36px;background:#3b82f620;font-size:16px">🎤</div><div style="flex:1"><div style="font-size:12px;font-weight:600;color:#111">Disclosure</div></div><span class="badge badge-gray" style="font-size:10px">Draft</span></div><div class="list-item"><div class="avatar-sq" style="width:36px;height:36px;background:#3b82f620;font-size:16px">🎤</div><div style="flex:1"><div style="font-size:12px;font-weight:600;color:#111">Mall Grab</div></div><span class="badge badge-gray" style="font-size:10px">Draft</span></div><div class="list-item"><div class="avatar-sq" style="width:36px;height:36px;background:#3b82f620;font-size:16px">🎤</div><div style="flex:1"><div style="font-size:12px;font-weight:600;color:#111">Peggy Gou</div></div><span class="badge badge-gray" style="font-size:10px">Draft</span></div><div class="list-item"><div class="avatar-sq" style="width:36px;height:36px;background:#3b82f620;font-size:16px">🎤</div><div style="flex:1"><div style="font-size:12px;font-weight:600;color:#111">Yaeji</div></div><span class="badge badge-gray" style="font-size:10px">Draft</span></div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">CSV Import</div>
  <div class="step-body">When you have many artists to add at once, use <strong>Import CSV</strong> from the Artists module instead of adding them one-by-one.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Prepare Your Spreadsheet</div>
  <div class="step-body">Export your lineup from any spreadsheet as a <strong>.csv file</strong>. The only required column is <code>name</code>. Optional: genre, instagram, spotify_url, status.</div>
  <div class="step-tip">Column headers must match exactly. Extra columns are ignored.</div>
  <div class="step-nav">
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Preview Before Importing</div>
  <div class="step-body">The app shows a preview table of what will be created. Review it — if anything looks wrong, cancel and fix the CSV first.</div>
...
<div class="step-panel" id="panel-3" style="display:none">
  ...
  <div class="step-title">Artists Created as Draft</div>
  <div class="step-body">All imported artists are created as <strong>Draft</strong>. Review and publish them individually or in bulk once you're ready to go live.</div>
