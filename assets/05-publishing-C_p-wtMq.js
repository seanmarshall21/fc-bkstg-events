...
<div class="phone">
  ...
  <div class="screen">
    ...
    <!-- Slide 0: Artist list with mix of statuses -->
  ...
  <div class="bar-avatar">SM</div>
    ...
    <!-- Slide 1: Artist detail publish toggle -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        <div class="card-row" style="margin-bottom:14px">
          ...
          <div>
            <div style="font-size:15px;font-weight:700;color:#111">Charlotte de Witte</div>
          </div>
        </div>
        <div class="card" style="margin-bottom:10px">
          <div class="toggle-row" style="border:none;padding:0">
            <div>
              <div style="font-size:13px;font-weight:600;color:#111">Status</div>
              <div class="badge badge-amber" style="margin-top:4px">Draft</div>
            </div>
            <button class="btn-primary" style="width:auto;padding:8px 16px;font-size:12px">Publish</button>
          </div>
        </div>
        <div class="field-group"><div class="field-label">Stage Name</div><div class="field-val">Charlotte de Witte</div></div>
        <div class="field-group"><div class="field-label">Genre</div><div class="field-val">Techno</div></div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 2: Now published -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        ...
        <div class="card" style="margin-bottom:10px;border-color:#86efac;background:#f0fdf4">
          <div class="toggle-row" style="border:none;padding:0">
            <div>
              <div style="font-size:13px;font-weight:600;color:#111">Status</div>
              <div class="badge badge-green" style="margin-top:4px">✓ Published</div>
            </div>
            <button style="background:#f3f4f6;color:#374151;border:none;border-radius:10px;padding:8px 14px;font-size:12px;font-weight:600">Unpublish</button>
          </div>
        </div>
        <div style="font-size:11px;color:#16a34a;text-align:center;padding:8px">Now visible on your website ✓</div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">Draft vs. Published</div>
  <div class="step-body">Every item in the app has a status. <strong>Draft</strong> items are saved but not visible on your website. <strong>Published</strong> items are live.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Publishing an Item</div>
  <div class="step-body">Open any artist, event, or sponsor. Tap <strong>Publish</strong> in the status section. The item goes live on WordPress immediately.</div>
  <div class="step-tip">This hits the WordPress REST API directly — no need to log into WP Admin.</div>
  <div class="step-nav">
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Unpublishing</div>
  <div class="step-body">Tap <strong>Unpublish</strong> to revert an item to Draft. Useful when pulling an artist announcement before it's ready, or archiving old content.</div>
