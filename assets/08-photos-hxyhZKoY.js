...
<div class="phone">
  ...
  <div class="screen">
    ...
    <!-- Slide 0: Artist detail with no photo -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        <div class="card-row" style="margin-bottom:14px">
          ...
          <div>
            <div style="font-size:15px;font-weight:700;color:#111">Mall Grab</div>
        ...
        <div class="upload-zone">
          ...
          <div style="font-size:12px;font-weight:600;color:#7c2dff">Tap to Upload</div>
          <div style="font-size:11px;color:#9ca3af">JPG, PNG · up to 10 MB</div>
        </div>
      </div>
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        <div style="font-size:14px;font-weight:700;color:#111;margin-bottom:14px">Mall Grab · Photos</div>
        <div class="card" style="margin-bottom:12px">
          <div class="card-row" style="margin-bottom:8px">
            <div style="width:40px;height:40px;border-radius:8px;background:#e8e5f0;flex-shrink:0"></div>
            <div style="flex:1">
              <div style="font-size:12px;font-weight:600;color:#111">mall-grab-press.jpg</div>
              <div style="font-size:11px;color:#9ca3af">Uploading…</div>
            </div>
          </div>
          <div class="progress-bar-outer"><div class="progress-bar-inner" style="width:65%"></div></div>
        </div>
        <div style="font-size:11px;color:#6b7280;text-align:center">Uploading directly to WordPress Media Library</div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
    </div>
    <!-- Slide 2: Photo uploaded, shown as thumbnail -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px">
          <div style="aspect-ratio:1;background:#3b82f630;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:28px">🎵</div>
          <div class="upload-zone" style="padding:16px;aspect-ratio:1;margin-bottom:0">
            <div style="font-size:20px">＋</div>
            <div style="font-size:10px;color:#7c2dff">Add</div>
          </div>
        </div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">Photo Upload Zone</div>
  <div class="step-body">Open any artist or event detail and scroll to the <strong>Photos</strong> section. Tap the upload zone to pick a photo from your camera roll.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Direct Upload to WordPress</div>
  <div class="step-body">Photos upload straight to your site's <strong>WordPress Media Library</strong> via the REST API — no FTP, no WP Admin, no size limits from the app side.</div>
  <div class="step-tip">File size limits are set by your server's PHP config (upload_max_filesize). Default is usually 64 MB.</div>
  <div class="step-nav">
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Photos Are Saved Inline</div>
  <div class="step-body">Once uploaded, the photo appears as a thumbnail in the record. Multiple photos stack in a grid. Tap to preview or remove.</div>
