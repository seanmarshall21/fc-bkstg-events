...
<title>Tutorial: Visibility & Confidential Mode — VC Event Manager</title>
<style>
...
<body>
<h1 class="page-head">Tutorial · Visibility & Confidential Mode</h1>
<div class="phone">
  <div class="notch"><div class="notch-pill"></div></div>
  <div class="screen">

    <!-- Slide 0: Normal artist detail -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        <div class="card-row" style="margin-bottom:14px">
          ...
          <div>
            <div style="font-size:15px;font-weight:700;color:#111">Disclosure</div>
            <div class="badge badge-green" style="margin-top:2px">Published</div>
          </div>
        </div>
        <div class="section-label">Public Fields</div>
        <div class="field-group"><div class="field-label">Stage Name</div><div class="field-val">Disclosure</div></div>
        <div class="field-group"><div class="field-label">Genre</div><div class="field-val">UK House / Electronic</div></div>
        <div class="section-label">Internal Notes</div>
        <div class="field-group"><div class="field-label">Booking Fee</div><div class="field-val">$45,000</div></div>
        <div class="field-group"><div class="field-label">Agent Contact</div><div class="field-val">james@wmg.com</div></div>
      </div>
    ...
    <!-- Slide 1: Confidential toggle in settings -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content">
        ...
        <div class="card" style="margin-bottom:12px">
          <div class="toggle-row" style="border:none;padding:0">
            <div>
              <div style="font-size:13px;font-weight:600;color:#111">Confidential Mode</div>
              <div style="font-size:11px;color:#9ca3af;margin-top:2px">Hide sensitive internal fields</div>
            </div>
            <div class="toggle on"></div>
          </div>
        </div>
        <div style="font-size:11px;color:#6b7280;line-height:1.5">Fields marked as confidential in ACF will be hidden when this mode is active — useful when sharing your screen.</div>
      </div>
    ...
    <!-- Slide 2: Artist detail with fields hidden -->
  ...
  <div class="bar-avatar">SM</div>
      ...
      <div class="page-content" style="padding-top:12px">
        ...
        <div class="field-group"><div class="field-label">Stage Name</div><div class="field-val">Disclosure</div></div>
        <div class="field-group"><div class="field-label">Genre</div><div class="field-val">UK House / Electronic</div></div>
        <div style="background:#fef9c3;border:1px solid #fde68a;border-radius:10px;padding:10px 12px;margin-top:4px">
          <div style="font-size:11px;font-weight:700;color:#ca8a04">🔒 Confidential Mode Active</div>
          <div style="font-size:11px;color:#92400e;margin-top:2px">Internal fields are hidden. Toggle off in Settings to view.</div>
        </div>
      </div>
      <div class="bottom-nav"><div class="nav-item active" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg><span class="nav-label">Home</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg><span class="nav-label">Search</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg><span class="nav-label">Faves</span></div><div class="nav-item" style="color:#fff"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M20 21a8 8 0 1 0-16 0"/></svg><span class="nav-label">Settings</span></div></div>
      <div class="home-bar"><div class="home-pill"></div></div>
...
<div class="step-panel" id="panel-0" style="display:block">
  ...
  <div class="step-title">Fields Are Visible by Default</div>
  <div class="step-body">All ACF fields — including internal ones like booking fees and agent contacts — are visible in artist and event records by default.</div>
...
<div class="step-panel" id="panel-1" style="display:none">
  ...
  <div class="step-title">Enable Confidential Mode</div>
  <div class="step-body">Go to <strong>Settings</strong> and toggle on <strong>Confidential Mode</strong>. This hides any field that's been marked confidential in the ACF field group.</div>
  <div class="step-tip">Great for presenting lineups on a big screen or sharing your device without exposing internal deal data.</div>
  <div class="step-nav">
...
<div class="step-panel" id="panel-2" style="display:none">
  ...
  <div class="step-title">Internal Fields Are Now Hidden</div>
  <div class="step-body">With Confidential Mode on, those internal sections disappear from all detail views. Toggle it back off any time to see everything again.</div>
